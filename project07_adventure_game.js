...
let player_actions = ["Attack", "Drink Health potion", "Run"];
let game_actions = ["Continue Fighting", "Exit dungeon"];
// game variables
let enemies = [
    "Skeleton",
    "Zombie",
...
// player variables
let health = 100;
let attack_damage = 50;
let num_health_potions = 3;
let health_potion_heal_amount = 30;
let health_potion_drop_chance = 50; // Percantage
let running = true;
async function gameOptionPrompt(options) {
